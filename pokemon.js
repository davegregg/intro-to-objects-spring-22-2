// Below this massive JSON string, you will find some more code!
const pokemonJSON = `
  {
    "abilities": [
      {
...
const displayPokemon = function (pokemon, parentElement) {
...
displayPokemon(pokemonObject, document.body)